...
1. Upload woocommerce-paystand to the `/wp-content/plugins/` folder.
2. Activate the plugin through the 'Plugins' menu in WordPress.
3. Under WooCommerce > Settings > Checkout > PayStand, add your Org ID and API key and choose whether you want to use the sandbox server for testing or the live production server.
4. Copy the webhook url from the settings page and go to your [PayStand dashboard](https://www.paystand.com/login) and enter it under Settings > Checkout Features > Webhook Url.
